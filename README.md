...
[![Test](https://github.com/mindearth/terrazarr/actions/workflows/ci.yml/badge.svg)](https://github.com/mindearth/terrazarr/actions/workflows/ci.yml)
[![PyPI](https://img.shields.io/pypi/v/terrazarr.svg)](https://pypi.org/project/terrazarr/)
...
computes every overview level from the whole previous level as one array in memory. It is fine at
...
- **Resumable.** Level 0 is written in windows and each one done is recorded, so an interrupted
  run finishes from the missing windows instead of
  starting over.
...
(24 cores, 43 GB), same settings. Following the wall time and peak memory of the whole process tree.
...
The full comparison, on synthetic rasters as
...
- [Francesco Asaro](mailto:francesco.asaro@mindearth.ch), [MindEarth](https://mindearth.ai/)
- [Federico Oldani](mailto:federico.oldani@mindearth.ch), [MindEarth](https://mindearth.ai/)
...
Space Agency (ESA), written by Development Seed, Apache License 2.0.

Terrazarr is licensed under the Apache License 2.0 credited in [NOTICE](NOTICE); see
[LICENSE](LICENSE) and cite with [CITATION.cff](CITATION.cff).
