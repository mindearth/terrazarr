...
writers: [benchmarks](https://mindearth.github.io/terrazarr/benchmarks/). The [demo](https://mindearth.github.io/terrazarr/demo/) serves the WSF-3D Italy pyramid from a
