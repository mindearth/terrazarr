...
run ours_t8 24G .venv/bin/python bench/run_one.py --impl optimized --input $IN --output $D/ours_t8.zarr --shard-size 4096 --chunk-size 256 --method mean --nodata 0 --sharding --threads 8 --workers 1 --quiet
run ours_w8 24G .venv/bin/python bench/run_one.py --impl optimized --input $IN --output $D/ours_w8.zarr --shard-size 4096 --chunk-size 256 --method mean --nodata 0 --sharding --threads 8 --workers 8 --quiet
...
run eopf 34G .venv-eopf/bin/python bench/tools/run_eopf.py --input $IN --output $D/eopf.zarr --shard-size 4096 --chunk-size 256 --min-dimension 256 --threads 8 --quiet
